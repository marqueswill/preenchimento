...
class SiggoDriver:
    ...
    def preparar_preechimento_cabecalho(self):
        ...
        df = pd.read_excel(caminho_completo, sheet_name="BENEFICIOS", header=None)
...
class PreenchimentoRGPSBeneficios(SiggoDriver):
    def __init__(self, test=False):
    ...
    def carregar_template_nl(self):
        ...
        dataframe = pd.read_excel(
            caminho_completo, header=6, sheet_name="BENEFICIOS", usecols="A:E"
        ).astype(str)
