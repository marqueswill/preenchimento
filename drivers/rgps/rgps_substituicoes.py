...
class SiggoDriver:
    ...
    def preparar_preechimento_cabecalho(self):
        ...
        df = pd.read_excel(caminho_completo, sheet_name="SUBSTITUICOES", header=None)
...
class PreenchimentoRGPSSubstituicoes(SiggoDriver):
    def __init__(self, test=False):
    ...
    def carregar_template_nl(self):
        ...
        dataframe = pd.read_excel(
            caminho_completo, header=6, sheet_name="SUBSTITUICOES", usecols="A:E"
        ).astype(str)
        return dataframe
